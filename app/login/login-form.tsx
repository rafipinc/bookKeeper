...
export default function LoginPage() {
  ...
  return (
    <main className="min-h-svh bg-zinc-100 px-4 flex items-center justify-center">
      <section className="w-full max-w-sm md:max-w-md rounded-xl border border-zinc-200 bg-white p-6 md:p-8 shadow-sm">
        <h1 className="text-2xl font-semibold tracking-tight text-blue-700">bookkeeping-app</h1>
        <p className="mt-1 text-sm text-zinc-500">Lean accounting for solo operators.</p>
        ...
        {sentEmail ? (
          <div className="mt-6 text-center">
            ...
            <button
              className="mt-4 text-sm font-medium text-blue-700 disabled:text-zinc-400"
