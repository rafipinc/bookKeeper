...
Loaded automatically when Claude Code launches in this directory.
...
- Claude Code and Codex must both treat `PROJECT_CONTEXT.md` as the living source of truth.
